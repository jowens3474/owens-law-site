...
const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "The Owens defense, led by Washington attorney Warren Gary Kohlman, will tell the jury this is not a corruption case. It is an entrapment case. The FBI, the defense will argue, spent two years and more than a million dollars manufacturing a crime that would not have existed without their undercover agents. The hotel was never going to be built. The vote was never going to be held. The government created the temptation, lured Owens into it, and now wants twelve Hinds County jurors to call the result a felony. Kohlman has argued before the U.S. Supreme Court and once defended a congressman caught in the FBI's original ABSCAM corruption sting in the 1980s. The legal playbook he used then is the same one he will use here.",
      ...
      "For Jackson, the trial is not just about three men. It is about whether a federal jury, drawn from Hinds County, decides that the people they elected to run their city were running it for the highest bidder. The recordings will be played. The cash will be photographed. The cooperators will name names. Then twelve neighbors will go behind a closed door and decide. The trial is scheduled to last about a month. The verdict, whenever it comes, will outlast the trial by years.",
    ],
  },
  {
