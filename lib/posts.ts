...
const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "For the broader market, the signal is the takeaway. If a developer is converting office to residential in a 10-percent-vacancy submarket, in the capital city of the Blackest state in the country, it says the rent gap between the two uses has gotten wide enough that conversion pays even where office isn't failing. Watch whether State Street announces a second phase or a downtown conversion next. If it does, this stops being a one-off and becomes a pipeline.",
