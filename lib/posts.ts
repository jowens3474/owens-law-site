...
const POSTS: Post[] = [
  {
    ...
    title: "Amazon's Ridgeland Water Deal Allows 14 Times Its Public Estimate. The Wastewater Flows to Jackson.",
    dek: "A contract obtained by the Mississippi Free Press lets Amazon draw up to 3.67 million gallons a day from a city of 25,000, with no other limit on use. Jackson, which banned data centers inside its own limits, will treat what comes out the other end.",
    ...
    views: 0,
    body: [
      "For a year, the public number on Amazon's Ridgeland data center has been 93 million gallons of water a year. It is the figure the company announced, the figure officials repeated, and the figure Amazon's economic development director softened further in April by saying the site would draw water only about 30 days a year, on the hottest days, when its cooling system needs it. The contract says something else. The water service agreement between Amazon and the City of Ridgeland, signed April 4, 2025, and obtained this week by the Mississippi Free Press through a public records request, authorizes the company to withdraw as much as 3.67 million gallons a day, every day, with no other guideline or restriction on everyday use.",
      "Run that cap for a year and it comes to roughly 1.3 billion gallons, about 14 times the estimate Amazon has given the public. The Free Press put the daily figure in terms a reader can picture: nearly 30 million standard water bottles. The estimate is a projection; the contract is the law between the parties. Nothing in the agreement obligates Amazon to stay near what it projected.",
      "The scale matters most against the size of the system supplying it. Ridgeland draws its water from six deep wells in the Cockfield and Sparta aquifers and can produce about 2.25 billion gallons a year, roughly 6.2 million gallons a day. Measured against the annual figure, Amazon's estimate is a modest 4 percent. Measured against what the contract actually permits, the company could claim close to 60 percent of the city's daily production capacity on any given day. Ridgeland has 25,000 residents. On a July afternoon when they are all running sprinklers and air conditioners, the contract does not say who comes first.",
      "That is the part of the story that belongs to Ridgeland. The part that belongs to Jackson is what happens to the water afterward. Ridgeland does not treat its own sewage. Like several suburbs, it sends its wastewater south under an interlocal agreement to Jackson's Savanna Street plant, and the Amazon agreement stipulates that wastewater from the data center will go the same way, to Jackson, for treatment and discharge. Once the site is running, some 83 million gallons of that treated wastewater is to be routed back for reuse solely at the facility, on the model of Amazon's operating campus in Canton.",
      "So the flow of the deal runs like this. Ridgeland sells the water and collects the revenue: about $2.5 million a year in new money by 2028, the city projects, and closer to $20 million once all 17 planned buildings are complete. Amazon puts up roughly $40 million for Ridgeland's water and sewer improvements, alongside a $63 million package of state-financed upgrades, a new main along West County Line Road, and a million-gallon storage tank. Then the used water crosses the county line into a sewer system that has been under a federal consent decree for its Clean Water Act violations for over a decade, that JXN Water took over in 2023 because the city could not run it, and that Jackson residents have watched fail in the streets of Belhaven and South Jackson this very summer. Experts quoted by the Free Press fear the influx could overburden it. Jackson gets no share of the $20 million. It gets the flush.",
      "Jackson's council, in July, voted 5 to 2 to become the first city in Mississippi to bar data centers inside its limits, at least until it writes rules for them, a 183-day pause that runs into early next year. The Ridgeland contract is the first hard evidence of what that moratorium does and does not accomplish. It keeps the buildings out. It does not keep the water out, because the metro's water and sewer systems were interlocked long before anyone in Seattle looked at a map of Madison County. A data center in Ridgeland is, at the pipe level, a Jackson project too.",
      "It is also the first look the public has had at what a negotiated deal in this state actually contains. When metro mayors went to the Legislature this year to defend data centers, the argument was that well-negotiated agreements bring infrastructure, buffers, and jobs. Mayor Gene McGee, asked about residents' fears of higher water bills, said the city had learned it can require Amazon to do certain things to negate those concerns, and pointed to noise. The water agreement is the test of that claim, and what it shows is a ceiling set at the physical capacity of the system rather than at the company's own estimate, and no mechanism below the ceiling at all. That is what a strong negotiating position produced in a city that wanted the deal.",
      "None of this means Amazon will use 3.67 million gallons a day. The company's own engineering says it will not; evaporative cooling of the kind planned for Ridgeland runs hard only when it is hot, and the Canton site's reuse of treated wastewater is genuinely more responsible than the industry norm. The Clinton site is air-cooled and will use almost no water. The point is not that the estimate is a lie. It is that the estimate is not enforceable, and the city signed the version that was not.",
      "For the council members now drafting Jackson's ordinance, the Ridgeland document is a template of what not to sign, and it arrives at a useful moment, because the ordinance still does not exist. The lessons are concrete. Cap withdrawals at the operator's stated estimate, not the system's capacity, with penalties above it. Require metered, publicly reported monthly usage. Write a drought clause that puts residential customers first when the wells are strained. Price sewer treatment at full cost, including the wear on a system under a consent decree. And insist that any reuse commitment be a contract term, not a press release.",
      "There is a harder question underneath, and it is Jackson's to ask of its own neighbors. The interlocal sewer agreements that carry Ridgeland's waste to Savanna Street were priced for a suburb's households, not for an industrial customer that can send millions of gallons a day. Whether JXN Water is charging Ridgeland, and by extension Amazon, a rate that reflects what that flow costs a broken system is a matter of public record that nobody has yet put on the record. The Wire has asked. Until the answer comes, the arithmetic of the Ridgeland deal stands as written: the water is sold in Madison County, the profits stay in Madison County, and the consequences are treated in Jackson.",
      "The moratorium bought Jackson time. This contract shows what the time is for. A city that could not keep its own water on in 2022 is being asked to absorb, downstream and at a discount, the growth its neighbor is being paid for. The council can write an ordinance that says so. What it cannot do is pretend the county line is a pipe.",
    ],
    note: "Sources: the Amazon and City of Ridgeland Water Service Agreement (April 4, 2025), as obtained and reported by the Mississippi Free Press on Sept. 17, 2026; Mississippi Today; WLBT; WJTV; the City of Ridgeland; JXN Water; Pearl Riverkeeper; and prior Wire reporting on the Jackson moratorium and the June 22 hearing. Annualized and percentage figures are the Wire's arithmetic from the reported cap and system capacity.",
  },
  {
