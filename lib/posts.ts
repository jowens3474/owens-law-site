...
const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "While the council works on citywide rules, a specific project is waiting in the wings. Saxum Investment Company wants to rezone roughly 190 acres along Forest Avenue in Northwest Jackson from residential, commercial, and light industrial to I-2 heavy industrial. The site is near the Ashley Acres neighborhood, where residents say they can see the property from their front doors.",
      ...
      "Councilman Kevin Parkison, who represents Ward 7, said at the June 23 meeting that the council is hearing from neighborhood associations that want to be part of the solution. 'There's many, many neighborhood associations who want to be part of blight elimination and want to be part of the solution,' he said, speaking about a separate code enforcement vote but capturing the broader mood of civic engagement.",
