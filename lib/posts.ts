...
const POSTS: Post[] = [
  {
    ...
    note: "The Wire confirmed the plea Monday. Full terms of the plea agreement were not yet available on the public docket at publication and this story will be updated. Sources: court records in United States v. Owens, No. 3:24-cr-103 (S.D. Miss.), and prior Wire reporting.",
  },
  {
