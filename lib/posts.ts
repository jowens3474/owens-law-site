...
const POSTS: Post[] = [
  {
    ...
    title: "Banks Moves to Force Prosecutors to Pick One Bribery Theory Before Trial",
    dek: "A filing made the day before trial preparations resume argues that Count Three illegally bundles the $10,000 cash payment with unspecified 'other things of value' into a single charge, threatening Banks's right to a unanimous jury verdict.",
    ...
    views: 0,
    body: [
      "Lawyers for Aaron B. Banks filed a motion on June 26 asking a federal judge to either order prosecutors to commit to a single factual theory on Count Three of the bribery indictment, or instruct the jury that it must unanimously agree on which alleged bribe it is convicting him of. Banks is the former president of the Jackson City Council and one of three defendants in the federal corruption case styled United States v. Owens.",
      "Count Three charges Banks with Federal Program Bribery under 18 U.S.C. Section 666(a)(1)(B). The indictment alleges that between January and February 2024, Banks \"corruptly solicited and demanded for his own benefit and accepted and agreed to accept things of value\" from co-defendant Jody E. Owens II and unnamed developers. The indictment identifies the things of value as \"$10,000.00 in cash and other things of value,\" in exchange for Banks's vote or votes on the developers' proposed project in Jackson.",
      "The motion argues that Count Three is duplicitous, meaning it combines two or more legally separate offenses inside a single count. Under the federal bribery statute, each solicitation, demand, or acceptance of a thing of value is its own discrete crime, not an installment in one larger offense. By writing \"other things of value\" into a single count alongside the $10,000 cash, the motion says prosecutors have created a situation where jurors could convict Banks without unanimously agreeing on what he actually did.",
      "The filing is explicit about the risk. Some jurors might accept the government's case on the $10,000 and reject the rest. Others might accept one or more of the unspecified \"other things of value\" and reject the cash theory. A guilty verdict on Count Three as written would leave Banks, his lawyers, and any appeals court unable to determine which theory the jury actually found credible. That ambiguity, the motion argues, would also strip Banks of any double-jeopardy protection if future prosecution were ever attempted on the same conduct.",
      "For purposes of the legal argument, the motion assumes that the \"other things of value\" referenced in the indictment are a job for Banks's daughter and a driver for his campaign, two items the government describes elsewhere in the same speaking indictment. The defense does not concede those allegations are true. Banks has maintained a not-guilty plea throughout the case.",
      "The motion draws on a line of federal cases interpreting Section 666. The most on-point precedent is United States v. Tutein, decided in the District of the Virgin Islands in 2000, where a court dismissed a single bribery count that bundled two separate alleged bribes from different months. That court held that \"every corrupt offer warrants a separate charge under Section 666.\" The motion also cites United States v. Nystrom, a 2008 South Dakota case that analyzed the statute's legislative history and concluded the allowable unit of prosecution is each individual payment, offer, or solicitation.",
      "The Fifth Circuit, which covers Mississippi, has not ruled directly on the unit of prosecution under Section 666, but it has addressed the remedy for duplicitous counts. Per United States v. Medel-Guadalupe, a 2021 Fifth Circuit opinion, \"the proper remedy to a duplicitous count in an indictment is to require the Government to elect upon which charge contained in the count it will rely.\" The motion quotes that language and asks Judge Daniel Jordan to apply it here.",
      "The alternative remedy, a unanimity-of-theory instruction, would tell jurors they must all agree on the same underlying bribe before returning a verdict. Banks's lawyers say they prefer forcing the government to elect because it simplifies the jury instructions, reduces evidentiary disputes, and removes the risk of the prosecution weaving together multiple fact theories at trial to satisfy the elements of the charge.",
      "Count Three is one of two counts Banks faces. Count One charges him with conspiracy alongside Owens and former Mayor Chokwe Antar Lumumba to accept things of value to influence city decisions, in violation of 18 U.S.C. Sections 371 and 666(a)(2). Trial is set for later this year in the Southern District of Mississippi, Northern Division. The government has not yet filed a response to the motion.",
    ],
